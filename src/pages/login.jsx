          ...
          <div className="card-body">
            ...
            <div className="form-control mt-6">
              <div className="github-btn my-2">
                <button class="bg-black text-white rounded-lg px-4 py-3 shadow-md flex items-center space-x-2 hover:bg-gray-800 focus:outline-none w-full">
                  <svg
                    class="w-5 h-5"
                    fill="currentColor"
                    viewBox="0 0 20 20"
              ...
              <div className="google-btn my-2">
                <button class="bg-red-600 text-white rounded-lg px-4 py-3 shadow-md flex items-center space-x-2 hover:bg-red-700 focus:outline-none w-full">
              ...
              <div className="twitter-btn my-2">
                <button class="bg-blue-400 text-white rounded-lg px-4 py-2 shadow-md flex items-center space-x-2 hover:bg-blue-500 focus:outline-none w-full">
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div className="facebook-btn my-2">
                <button class="bg-blue-600 text-white rounded-lg px-4 py-2 shadow-md flex items-center space-x-2 hover:bg-blue-700 focus:outline-none w-full">
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
